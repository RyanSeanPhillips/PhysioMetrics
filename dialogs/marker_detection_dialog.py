...
class MarkerDetectionDialog(ExportMixin, QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._window_before_spin.setRange(0.5, 99999.9)
        self._window_before_spin.setValue(5.0)
        self._window_after_spin = QDoubleSpinBox()
        self._window_after_spin.setRange(1.0, 99999.9)
    ...
    def _on_plot_right_click(self, evt) -> None:
        ...
        before_spin.setRange(0.5, 99999.9)
        before_spin.setSuffix(" s")
        before_spin.setSingleStep(5.0)
        ...
        after_spin.setRange(1.0, 99999.9)
        after_spin.setSuffix(" s")
        after_spin.setSingleStep(5.0)
